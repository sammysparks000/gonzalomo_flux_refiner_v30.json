# gonzalomo_flux_refiner_v30.json

Dockerized ComfyUI workflow: gonzaLomo_Flux_Refiner_v30.json
...
docker build -t gonzalomo_flux_refiner_v30.json .

# Run the container
docker run -p 8188:8188 gonzalomo_flux_refiner_v30.json
```
